  ...
  <div class="mine-wrap">
    ...
    <div class="main-box">
      <div class="action-row">
        <el-button class="soft-primary" type="primary" @click="dialogVisible = !dialogVisible"
          >修改个人信息</el-button
        >
      </div>
      <el-descriptions
...
.soft-primary {
  ...
  box-shadow:
    6px 6px 12px rgba(145, 165, 194, 0.35),
...
.soft-primary:active {
  box-shadow:
    inset 4px 4px 8px rgba(112, 130, 159, 0.35),
    inset -4px -4px 8px rgba(255, 255, 255, 0.84);
}
...
:deep(.el-dialog) {
  ...
  box-shadow:
    14px 14px 28px rgba(148, 166, 192, 0.34),
